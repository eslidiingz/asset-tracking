                    ...
                    <div class="space-y-1 mt-2">
                        <div class="flex justify-between items-end text-xs">
                            ...
                            <div class="text-right font-bold"
                                :class="{ 'text-green-500': (port?.profit_percentage || 0) > 0, 'text-red-500': (port?.profit_percentage || 0) < 0 }">
                                {{ formatNumber(port?.profit_amount || 0) }} ({{
                                    formatNumber(port?.profit_percentage || 0, 2) }}%)</div>
                        </div>
